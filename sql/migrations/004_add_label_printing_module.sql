...
ON label_templates FOR SELECT TO authenticated USING (true);

CREATE POLICY "Allow authenticated users to insert label templates" 
ON label_templates FOR INSERT TO authenticated WITH CHECK (true);

CREATE POLICY "Allow authenticated users to update label templates" 
ON label_templates FOR UPDATE TO authenticated USING (true);

CREATE POLICY "Allow authenticated users to delete label templates" 
ON label_templates FOR DELETE TO authenticated USING (true);

CREATE POLICY "Allow authenticated users to read print jobs" 
ON print_jobs FOR SELECT TO authenticated USING (true);

CREATE POLICY "Allow authenticated users to insert print jobs" 
ON print_jobs FOR INSERT TO authenticated WITH CHECK (true);

CREATE POLICY "Allow authenticated users to update print jobs" 
ON print_jobs FOR UPDATE TO authenticated USING (true);

CREATE POLICY "Allow authenticated users to delete print jobs" 
ON print_jobs FOR DELETE TO authenticated USING (true);
